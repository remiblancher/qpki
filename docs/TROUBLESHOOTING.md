...
- [1. Common Errors](#1-common-errors)
  - [1.1 CA Errors](#11-ca-errors)
  - [1.2 Credential Errors](#12-credential-errors)
  - [1.3 Profile Errors](#13-profile-errors)
  - [1.4 Certificate Errors](#14-certificate-errors)
  - [1.5 CRL/OCSP Errors](#15-crlocsp-errors)
- [2. Diagnostic Commands](#2-diagnostic-commands)
  - [2.1 CA Diagnostics](#21-ca-diagnostics)
  - [2.2 Credential Diagnostics](#22-credential-diagnostics)
  - [2.3 Certificate Diagnostics](#23-certificate-diagnostics)
  - [2.4 Profile Diagnostics](#24-profile-diagnostics)
  - [2.5 CRL Diagnostics](#25-crl-diagnostics)
- [3. OpenSSL Verification](#3-openssl-verification)
  - [3.1 Certificate Verification](#31-certificate-verification)
  - [3.2 Key Verification](#32-key-verification)
  - [3.3 CSR Verification](#33-csr-verification)
  - [3.4 CRL Verification](#34-crl-verification)
- [4. HSM/PKCS#11 Issues](#4-hsmpkcs11-issues)
  - [4.1 Token Not Found](#41-token-not-found)
  - [4.2 PIN Incorrect](#42-pin-incorrect)
  - [4.3 Slot Unavailable](#43-slot-unavailable)
- [5. File System Issues](#5-file-system-issues)
  - [5.1 Permission Denied](#51-permission-denied)
  - [5.2 Directory Structure](#52-directory-structure)
- [6. Debug Mode](#6-debug-mode)
- [7. Getting Help](#7-getting-help)
  - [7.1 Built-in Help](#71-built-in-help)
