...
- [1. Introduction](#1-introduction)
  - [1.1 Why Crypto-Agility?](#11-why-crypto-agility)
  - [1.2 Migration Strategies](#12-migration-strategies)
- [2. CA Crypto-Agility](#2-ca-crypto-agility)
  - [2.1 CA Rotation Overview](#21-ca-rotation-overview)
  - [2.2 ca rotate](#22-ca-rotate)
  - [2.3 ca activate](#23-ca-activate)
  - [2.4 ca versions](#24-ca-versions)
  - [2.5 Cross-Signing](#25-cross-signing)
- [3. Credential Crypto-Agility](#3-credential-crypto-agility)
  - [3.1 Multi-Profile Enrollment](#31-multi-profile-enrollment)
  - [3.2 credential rotate with Profile Changes](#32-credential-rotate-with-profile-changes)
- [4. Migration Scenarios](#4-migration-scenarios)
  - [4.1 EC → Catalyst → ML-DSA (Full Transition)](#41-ec--catalyst--ml-dsa-full-transition)
  - [4.2 EC → ML-DSA (Direct Transition)](#42-ec--ml-dsa-direct-transition)
  - [4.3 RSA → EC → ML-DSA (Legacy Migration)](#43-rsa--ec--ml-dsa-legacy-migration)
  - [4.4 Catalyst → ML-DSA (Hybrid to PQ)](#44-catalyst--ml-dsa-hybrid-to-pq)
  - [4.5 Multi-Profile (Parallel Algorithms)](#45-multi-profile-parallel-algorithms)
- [5. Best Practices](#5-best-practices)
  - [5.1 Planning Migration](#51-planning-migration)
  - [5.2 Timing Considerations](#52-timing-considerations)
  - [5.3 Monitoring](#53-monitoring)
  - [5.4 Rollback](#54-rollback)
- [6. Algorithm Reference](#6-algorithm-reference)
  - [6.1 Classical Algorithms](#61-classical-algorithms)
  - [6.2 Post-Quantum Algorithms](#62-post-quantum-algorithms)
  - [6.3 Hybrid Algorithms](#63-hybrid-algorithms)
- [See Also](#see-also)
