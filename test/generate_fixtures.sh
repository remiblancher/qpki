...
"$PKI" ca init --profile ec/root-ca --var cn="Test ECDSA CA" --dir "$OUT/classical/ca"
...
"$PKI" ca init --profile ml/root-ca --var cn="Test ML-DSA CA" --dir "$OUT/pqc/mldsa/ca"
...
"$PKI" ca init --profile slh/root-ca --var cn="Test SLH-DSA CA" --dir "$OUT/pqc/slhdsa/ca"
...
"$PKI" ca init --profile hybrid/catalyst/root-ca --var cn="Test Catalyst CA" --dir "$OUT/catalyst/ca"
...
"$PKI" ca init --profile hybrid/composite/root-ca --var cn="Test Composite CA" --dir "$OUT/composite/ca"
