...
func parseSLHDSAPEMType(pemType string) (AlgorithmID, slhdsa.ID, bool) {
	slhTypes := map[string]struct {
		...
		// SHA2 variants
		"SLH-DSA-SHA2-128s PRIVATE KEY": {AlgSLHDSASHA2128s, slhdsa.SHA2_128s},
		"SLH-DSA-SHA2-128f PRIVATE KEY": {AlgSLHDSASHA2128f, slhdsa.SHA2_128f},
		"SLH-DSA-SHA2-192s PRIVATE KEY": {AlgSLHDSASHA2192s, slhdsa.SHA2_192s},
		"SLH-DSA-SHA2-192f PRIVATE KEY": {AlgSLHDSASHA2192f, slhdsa.SHA2_192f},
		"SLH-DSA-SHA2-256s PRIVATE KEY": {AlgSLHDSASHA2256s, slhdsa.SHA2_256s},
		"SLH-DSA-SHA2-256f PRIVATE KEY": {AlgSLHDSASHA2256f, slhdsa.SHA2_256f},
		// SHAKE variants
		"SLH-DSA-SHAKE-128s PRIVATE KEY": {AlgSLHDSASHAKE128s, slhdsa.SHAKE_128s},
		"SLH-DSA-SHAKE-128f PRIVATE KEY": {AlgSLHDSASHAKE128f, slhdsa.SHAKE_128f},
		"SLH-DSA-SHAKE-192s PRIVATE KEY": {AlgSLHDSASHAKE192s, slhdsa.SHAKE_192s},
		"SLH-DSA-SHAKE-192f PRIVATE KEY": {AlgSLHDSASHAKE192f, slhdsa.SHAKE_192f},
		"SLH-DSA-SHAKE-256s PRIVATE KEY": {AlgSLHDSASHAKE256s, slhdsa.SHAKE_256s},
		"SLH-DSA-SHAKE-256f PRIVATE KEY": {AlgSLHDSASHAKE256f, slhdsa.SHAKE_256f},
	}
